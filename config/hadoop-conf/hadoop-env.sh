...
# File naming remote worker hosts.  $HADOOP_HOME/conf/workers by default.
# export HADOOP_WORKERS=${HADOOP_HOME}/conf/workers

# host:path where hadoop code should be rsync'd from.  Unset by default.
# export HADOOP_MASTER=master:/home/$USER/src/hadoop

# Seconds to sleep between worker commands.  Unset by default.  This
# can be useful in large clusters, where, e.g., worker rsyncs can
